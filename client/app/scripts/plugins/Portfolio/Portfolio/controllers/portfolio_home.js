...
angular.module('getlancerApp.Portfolio')
    .controller('PortfoliosHomeController', ['$scope', '$rootScope', '$location', '$window', '$filter', '$state', 'md5', 'PortfoliosFactory', 'flash', '$uibModal', '$uibModalStack', 'HelperFactory', 'SweetAlert', 'Upload', '$stateParams', 'PortfolioConstant', 'PortfolioSkillsFactory', 'Slug', 'PortfolioAutocompleteUsers', 'ConstUserRole', '$timeout', function($scope, $rootScope, $location, $window, $filter, $state, md5, PortfoliosFactory, flash, $uibModal, $uibModalStack, HelperFactory, SweetAlert, Upload, $stateParams, PortfolioConstant, PortfolioSkillsFactory, Slug, PortfolioAutocompleteUsers, ConstUserRole, $timeout) {
        ...
        function getPortfolioData() {
            ...
            PortfoliosFactory.getall(params, function(response) {
                if (chkLoginParams(PortfolioConstant.Myportfolios) === false) {
